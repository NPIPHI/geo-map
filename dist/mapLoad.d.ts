...
export declare function loadMapChuncksBinary(dir: string, target: Layer): Promise<void>;
export declare function addMapBinary(path: string, target: Layer): Promise<void>;
export declare function loadMapChuncksJSON(dir: string, target: Layer): Promise<void>;
